...
const ProductList = () => {
  ...
  const [setId,{res}] = useDeleteProductMutation()
            ...
            {userProducts?.map((product, index) => (
              <>
                <tr>
                  ...
                  <td>
                    {
                      likes?.filter((like) => like?.product_id === product?._id)
                        ?.length
                    }
                  </td>
                  <td>
                  ...
                  <td>
                    <span className="bg-orange-500 rounded-md p-1 text-white">
                      pending
                    </span>
                  </td>
                  <td>
